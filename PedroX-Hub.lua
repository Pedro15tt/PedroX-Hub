...
local trueData = "3258837b23be435b8d06e687bb4fc5a3"
local falseData = "5622450f99e0420f806425765131acb4"

KeyGuardLibrary.Set({
  publicToken = "657b0d2ddfbb4245b28fd13136322e77",
  privateToken = "b6595954b82b47ca9d7edd4f17a924ce",
  trueData = trueData,
  falseData = falseData,
})
                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script PedroX Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://92240719754338" }),
